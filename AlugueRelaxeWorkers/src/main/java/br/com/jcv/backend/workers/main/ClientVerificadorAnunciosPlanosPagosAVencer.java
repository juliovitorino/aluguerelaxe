...
import br.com.jcv.backend.workers.VerificadorAnunciosPlanosPagosAVencer;

public class ClientVerificadorAnunciosPlanosPagosAVencer {
	...
	public static void main(String[] args) {
		...
		Robot sppp = new VerificadorAnunciosPlanosPagosAVencer();
		sppp.executar();
	}
