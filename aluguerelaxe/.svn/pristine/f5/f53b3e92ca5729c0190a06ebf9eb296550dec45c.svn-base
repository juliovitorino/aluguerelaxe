...
public class PromocaoPadrao implements EntryPoint,
		AsyncCallback<VOPadrao>, WizardListener {

	public static final String GWT_PROMO_AMIGO_INDICA_AMIGO = "gwt-promo-padrao";

	PromocaoPadraoWizard paiawzrd;
	

	public void onModuleLoad() {
		paiawzrd = new PromocaoPadraoWizard();
	...
	public void onConcluirClick() {
		...
		PromocaoPadraoVO vo = paiawzrd.getVO();
	...
	public void onSuccess(VOPadrao result) {
		if (result != null){
			...
			paiawzrd.showCompositeFinal(new EmailEnviadoPromocaoPadraoFormComposite(), paiawzrd.montaHeaderPasso("flag_checkered.png", "Conclu\u00eddo"));
