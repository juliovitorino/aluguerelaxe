 ...
 *
 */
public class TemplateThreadCriada extends Template {

	public TemplateThreadCriada(Map<String,String> conteudo) throws  AlugueRelaxeException {
		super(VariavelCache.getInstance().getValor(VariavelConstantes.TEMPLATE_PATH).concat("template-thread-criada.html"));
