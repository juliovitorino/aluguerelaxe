 ...
 *
 */
public class TemplateThreadParaAnunciante extends Template {

	public TemplateThreadParaAnunciante(Map<String,String> conteudo) throws  AlugueRelaxeException {
		super(VariavelCache.getInstance().getValor(VariavelConstantes.TEMPLATE_PATH).concat("template-thread-para-anunciante.html"));
