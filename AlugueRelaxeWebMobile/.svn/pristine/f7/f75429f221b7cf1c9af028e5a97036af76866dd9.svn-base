...
public class AnuncioGrid extends AbstractAnuncio {
	...
	public Widget render() {
		...
		if (ifcvo.imagensImovelXG == null){
			sb.append("           <img src=\"/armob/images/no-photo.jpg\" data-src=\"holder.js/300x200\" alt=\"...\">");
		} else {
			sb.append("           <img src=\"" + ifcvo.imagensImovelXG.get(0).nome + "\" data-src=\"holder.js/300x200\" alt=\"...\">");
		}
		sb.append("           <div class=\"caption\">");
		sb.append("             <h3>Propriedade #" + ifcvo.imovel.id + "</h3>");
		sb.append("             <p>" + ifcvo.imovel.descricaoTituloAnuncio + "</p>");
		sb.append("            	<p><a href=\"" + ifcvo.urlFichaImovelMobile + "\" class=\"btn btn-primary\" role=\"button\">Detalhes</a></p>");
		sb.append("           </div>");
		sb.append("      </div>");
		sb.append("   </div>");
		sb.append("</div>");
