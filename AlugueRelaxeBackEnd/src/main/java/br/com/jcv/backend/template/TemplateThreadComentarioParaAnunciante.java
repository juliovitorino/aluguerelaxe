 ...
 *
 */
public class TemplateThreadComentarioParaAnunciante extends Template {

	public TemplateThreadComentarioParaAnunciante(Map<String,String> conteudo) throws  AlugueRelaxeException {
		super(VariavelCache.getInstance().getValor(VariavelConstantes.TEMPLATE_PATH).concat("template-thread-comentario-para-anunciante.html"));
