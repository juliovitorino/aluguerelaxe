...
/**
*
* <h2>BloqueadorAnunciosGratuitosVencidos</h2>
* <p>Bloqueador de anuncios gratuitos vencidos </p>
* @author julio
*/
public class BloqueadorAnunciosGratuitosVencidos extends Robot {

	public static final String ROBOT_NOME = "BLOQUEADOR_PLANOS_GRATUITOS_VENCIDOS";

	public BloqueadorAnunciosGratuitosVencidos() {
		super(ROBOT_NOME, "Bloqueador de anuncios gratuitos vencidos");
	}
	
	public void executar() {
	
		this.setStatus(CicloVidaRobot.ROBOT_TRABALHANDO,"Iniciando bloqueador de anuncios gratuitos vencidos");
		try {
			...
			List<Long> lstPlanosAVencer = ipfs.listarPlanosGratuitosVencidos();
