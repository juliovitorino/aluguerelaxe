...
import br.com.jcv.backend.workers.BloqueadorAnunciosPendentesVencidos;

public class ClientBloqueadorAnunciosPendentesVencidos {
	...
	public static void main(String[] args) {
		...
		Robot sppp = new BloqueadorAnunciosPendentesVencidos();
		sppp.executar();
	}
