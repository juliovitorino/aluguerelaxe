...
public class InstrucoesFinaisPromocaoPadraoFormComposite extends FormComposite<VOPadrao> {
	
	private static final String INSTR_HTML = "<h3>Passo Final</h3>" +
	"<p>Para concluir com sucesso sua participa\u00e7\u00e3o na promo\u00e7\u00e3o do AlugueRelaxe, voc\u00ea precisa clicar no bot\u00e3o <b>Concluir</b>.</p>" +
	"<p>Ser\u00e1 enviado para o e-mail informado neste cadastro uma chave de ativa\u00e7\u00e3o da promo\u00e7\u00e3o para que voc\u00ea possa " +
	...
	public InstrucoesFinaisPromocaoPadraoFormComposite() {
		super();
	}
