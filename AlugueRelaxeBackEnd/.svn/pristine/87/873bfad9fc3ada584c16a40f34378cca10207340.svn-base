...
public class TemplateNotificacaoAnunciosAVencer extends Template {


	public TemplateNotificacaoAnunciosAVencer(Map<String,String> conteudo) throws  AlugueRelaxeException {
		super(VariavelCache.getInstance().getValor(VariavelConstantes.TEMPLATE_PATH).concat("template-notifica-anuncios-a-vencer.html"));
