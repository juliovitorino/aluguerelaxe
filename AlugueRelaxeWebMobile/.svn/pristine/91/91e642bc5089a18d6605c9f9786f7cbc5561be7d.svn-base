...
import br.com.jcv.aluguerelaxe.client.mobile.componente.portaretrato.PortaRetrato;
import br.com.jcv.aluguerelaxe.client.mobile.componente.portaretrato.PortaRetratoListener;
