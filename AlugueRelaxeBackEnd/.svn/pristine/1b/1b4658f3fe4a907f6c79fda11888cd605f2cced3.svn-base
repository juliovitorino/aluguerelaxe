 ...
 *
 */
public class TemplateValidarPreReservaVisitante extends Template {

	public TemplateValidarPreReservaVisitante(Map<String,String> conteudo) throws  AlugueRelaxeException {
		super(VariavelCache.getInstance().getValor(VariavelConstantes.TEMPLATE_PATH).concat("template-validar-pre-reserva-visitante.html"));
