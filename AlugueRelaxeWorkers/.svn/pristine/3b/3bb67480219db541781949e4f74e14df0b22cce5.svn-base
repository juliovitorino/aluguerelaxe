...
import br.com.jcv.backend.workers.BloqueadorAnunciosPagosVencidos;

public class ClientBloqueadorAnunciosPagosVencidos {
	...
	public static void main(String[] args) {
		...
		Robot sppp = new BloqueadorAnunciosPagosVencidos();
		sppp.executar();
	}
