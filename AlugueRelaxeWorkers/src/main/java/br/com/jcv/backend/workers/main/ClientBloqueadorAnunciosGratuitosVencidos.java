...
import br.com.jcv.backend.workers.BloqueadorAnunciosGratuitosVencidos;

public class ClientBloqueadorAnunciosGratuitosVencidos {
	...
	public static void main(String[] args) {
		...
		Robot sppp = new BloqueadorAnunciosGratuitosVencidos();
		sppp.executar();
	}
