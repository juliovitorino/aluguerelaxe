...
import br.com.jcv.backend.workers.GeradorPaginasOfflineProperta;

public class ClientGeradorPaginasOfflineProperta {
	...
	public static void main(String[] args) {
		...
		Robot sppp = new GeradorPaginasOfflineProperta();
		sppp.executar();
	}
