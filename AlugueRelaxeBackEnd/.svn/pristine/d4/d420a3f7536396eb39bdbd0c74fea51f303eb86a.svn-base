 ...
 *
 */
public class TemplateThreadParaVisitanteResposta extends Template {

	public TemplateThreadParaVisitanteResposta(Map<String,String> conteudo) throws  AlugueRelaxeException {
		super(VariavelCache.getInstance().getValor(VariavelConstantes.TEMPLATE_PATH).concat("template-thread-para-visitante-resposta.html"));
