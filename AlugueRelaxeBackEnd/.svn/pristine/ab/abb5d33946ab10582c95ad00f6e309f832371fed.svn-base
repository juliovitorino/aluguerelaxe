 ...
 *
 */
public class TemplateExecutarTransferenciaDeposito extends Template {

	public TemplateExecutarTransferenciaDeposito(Map<String,String> conteudo) throws  AlugueRelaxeException {
		super(VariavelCache.getInstance().getValor(VariavelConstantes.TEMPLATE_PATH).concat("template-executar-transferencia-deposito.html"));
