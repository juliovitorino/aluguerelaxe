...
import br.com.jcv.backend.workers.GerenciadorAprovacoesPendentes;

public class ClientGerenciadorAprovacoesPendentes {
	...
	public static void main(String[] args) {
		...
		Robot sppp = new GerenciadorAprovacoesPendentes();
		sppp.executar();
	}
