...
public class TemplateContatoAnunicianteLiberado extends Template {


	public TemplateContatoAnunicianteLiberado(Map<String,String> conteudo) throws  AlugueRelaxeException {
		super(VariavelCache.getInstance().getValor(VariavelConstantes.TEMPLATE_PATH).concat("template-contato-anunciante-liberado.html"));
