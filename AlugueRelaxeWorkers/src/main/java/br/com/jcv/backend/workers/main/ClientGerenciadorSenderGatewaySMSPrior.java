...
import br.com.jcv.backend.workers.GerenciadorSenderGatewaySMSPrior;

public class ClientGerenciadorSenderGatewaySMSPrior {
	...
	public static void main(String[] args) {
		...
		Robot sppp = new GerenciadorSenderGatewaySMSPrior();
		sppp.executar();
	}
