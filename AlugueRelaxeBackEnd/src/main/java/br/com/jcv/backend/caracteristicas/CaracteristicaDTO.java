 ...
 * @since 31 May 2009
 */
public class CaracteristicaDTO extends DTOPadrao implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8253173992189199736L;
	/**
	 * <h2>Atributo id</h2>
	...
	/**
	 * <h2>Atributo nome</h2>
	 * <p>Nome da característica. Tipo <code>String</code>.</p>
	 */
	public String nome;
	/**
	 ...
	 * corrente do objeto.</p>
	 * @param Long - valor que será atribuído como código.
