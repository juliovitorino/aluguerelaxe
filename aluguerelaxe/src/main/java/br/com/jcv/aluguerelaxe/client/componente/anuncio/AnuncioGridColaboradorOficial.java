 ...
 *
 */
public class AnuncioGridColaboradorOficial extends AbstractAnuncio {
	
	public static final String PATH_IMAGEM = "images/";
	public static final String PATH_IMAGEM_48 = "images/48x48/";
	private static final String TEMA_HEADER = "blue01";
	
	public AnuncioGridColaboradorOficial(ImovelFichaCompletaVO ifcvo) {
		super(ifcvo);
		this.setStylePrimaryName("gwt-AnuncioGridColaboradorOficial");
	}
	...
	private Widget montaRodape(ImovelFichaCompletaVO ifcvo) {
		...
		if ((ifcvo.imovel.valorTarifaBasica != null) && (ifcvo.imovel.valorTarifaBasica.length() > 0)) {
			...
			Image imgpo = new Image(PATH_IMAGEM + "imv_colab.png");
