...
public class TemplateNotificarCadastroAlteracaoImovel extends Template {


	public TemplateNotificarCadastroAlteracaoImovel(Map<String,String> conteudo) throws  AlugueRelaxeException {
		super(VariavelCache.getInstance().getValor(VariavelConstantes.TEMPLATE_PATH).concat("template-notificar-cadastro-alteracao-imovel.html"));
