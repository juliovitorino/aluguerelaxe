 ...
 *
 */
public class AnuncioSuperBanner extends AbstractAnuncio {
	...
	public AnuncioSuperBanner(ImovelFichaCompletaVO ifcvo) {
		super(ifcvo);
	...
	private Widget montaFotoImovel(ImovelFichaCompletaVO ifcvo) {
		...
		vp.add(img);
		vp.add(new Label(ifcvo.imovel.valorTarifaBasica));
		return vp;
	}
