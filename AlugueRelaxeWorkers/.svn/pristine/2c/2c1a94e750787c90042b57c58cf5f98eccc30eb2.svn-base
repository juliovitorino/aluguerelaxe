...
import br.com.jcv.backend.workers.VerificadorAnunciosPlanosGratuitosAVencer;

public class ClientVerificadorAnunciosPlanosGratuitosAVencer {
	...
	public static void main(String[] args) {
		...
		Robot sppp = new VerificadorAnunciosPlanosGratuitosAVencer();
		sppp.executar();
	}
