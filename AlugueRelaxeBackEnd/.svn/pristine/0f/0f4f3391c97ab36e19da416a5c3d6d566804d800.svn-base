...
public class TemplateNotificaPlanoRenovado extends Template {


	public TemplateNotificaPlanoRenovado(Map<String,String> conteudo) throws  AlugueRelaxeException {
		super(VariavelCache.getInstance().getValor(VariavelConstantes.TEMPLATE_PATH).concat("template-notifica-plano-renovado.html"));
