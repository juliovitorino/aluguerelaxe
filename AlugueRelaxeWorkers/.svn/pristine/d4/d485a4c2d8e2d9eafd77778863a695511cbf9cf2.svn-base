...
/**
*
* <h2>Alerta24HSenderGatewaySMS</h2>
* <p>Enviador de alertas para usuarios Alerta 24H</p>
* @author julio
*/
public class Alerta24HSenderGatewaySMS extends Robot implements IAlerta24H  {

	public static final String ROBOT_NOME = "SENDER_ALERTA_24H_GATEWAY_SMS";


	public Alerta24HSenderGatewaySMS() {
		super(ROBOT_NOME, "EMISSOR NO GATEWAY SMS DO ALTERA 24H");
	}
	...
	public void executar(AlertaDTO dto) {
		...
		try {
			if (VariavelCache.getInstance().getValor(VariavelConstantes.PERMITIR_ENVIO_SMS_GATEWAY).equals("ON")){
				// Popula o DTO com as informacoes para enfileirar a mensagem SMS
		...
		this.setStatus(CicloVidaRobot.ROBOT_TERMINADO,"SMS via Gateway para " + 
				dto.ifcdto.cliente.nome + " enfileirado com sucesso.");
	}
