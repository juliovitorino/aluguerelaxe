...
import br.com.jcv.backend.workers.RenovadorSorteioPublicidadePD;

public class ClientRenovadorSorteioPublicidadePD {
	...
	public static void main(String[] args) {
		...
		Robot sppp = new RenovadorSorteioPublicidadePD();
		sppp.executar();
