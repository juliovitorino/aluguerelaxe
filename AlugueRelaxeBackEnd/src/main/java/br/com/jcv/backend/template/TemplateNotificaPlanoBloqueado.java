...
public class TemplateNotificaPlanoBloqueado extends Template {


	public TemplateNotificaPlanoBloqueado(Map<String,String> conteudo) throws  AlugueRelaxeException {
		super(VariavelCache.getInstance().getValor(VariavelConstantes.TEMPLATE_PATH).concat("template-notifica-plano-bloqueado.html"));
