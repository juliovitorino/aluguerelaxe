package br.com.jcv.aluguerelaxe.client.calendar;
/*
...
public class CalendarWidget extends Composite 
  ...
  private class NavBar extends Composite implements ClickListener {
    ...
    public final Button prevMonth = new Button("&lsaquo;", this);
    public final Button prevYear = new Button("&laquo;", this);
    public final Button nextYear = new Button("&raquo;", this);
    public final Button nextMonth = new Button("&rsaquo;", this);
  ...
  private String[] days = new String[] { "Domingo", "Segunda", "Terça",
      "Quarta", "Quinta", "Sexta", "S\u00e1bado" };

  private String[] months = new String[] { "Jan", "Fev", "Mar",
