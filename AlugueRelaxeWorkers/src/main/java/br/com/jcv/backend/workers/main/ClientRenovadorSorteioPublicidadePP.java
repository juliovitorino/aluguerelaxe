...
import br.com.jcv.backend.workers.RenovadorSorteioPublicidadePP;

public class ClientRenovadorSorteioPublicidadePP {
	...
	public static void main(String[] args) {
		...
		Robot sppp = new RenovadorSorteioPublicidadePP();
		sppp.executar();
