 ...
 */
public class InstrucoesFinaisNovaContaFormComposite extends FormComposite<VOPadrao> {
	
	private static final String INSTR_HTML = "<h3>Assistente de Abertura de Conta</h3>" +
	"<p>Foi enviado para o email cadastrado um link de acesso. Entre l\u00e1 e clique para ativar sua conta. " +
	...
	public InstrucoesFinaisNovaContaFormComposite() {
		super();
