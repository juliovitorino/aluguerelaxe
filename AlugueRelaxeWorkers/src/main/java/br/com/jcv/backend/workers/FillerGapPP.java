...
* @author julio
*/
public class FillerGapPP extends Sorteio {
	...
	public void executar() {
		...
		try {
			...
			int qtdGrade = is.contarGradePublicidade(dataGap.add(1), "PP");
			...
			if (qtdGrade == 0){
				...
				DateManagerBase dataFinalPP = DateManager.getDateManagerInstance(dataGap.add(qtdDiasPrazoSorteio));
